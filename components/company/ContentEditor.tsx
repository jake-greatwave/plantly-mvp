...
import { Bold, Italic, List, ListOrdered, Heading1, Heading2, Undo, Redo, Palette, Type } from 'lucide-react'
  ...
  const editor = useEditor({
    extensions: [
      ...
      Placeholder.configure({
        placeholder: '기업 소개, 제품 설명, 회사 문화 등을 자유롭게 작성해주세요...',
      }),
      Image.configure({
        inline: true,
        allowBase64: true,
        ...
        <Popover open={colorOpen} onOpenChange={setColorOpen}>
          <PopoverTrigger asChild>
            <Button
              ...
              variant="ghost"
              size="sm"
              className={editor.isActive('textStyle') && editor.getAttributes('textStyle').color ? 'bg-gray-200' : ''}
            >
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button
              ...
              variant="ghost"
              size="sm"
              className={editor.getAttributes('textStyle').fontSize ? 'bg-gray-200' : ''}
            >
